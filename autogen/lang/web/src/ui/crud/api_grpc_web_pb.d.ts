...
export class CrudClient {
  ...
  putViewOverride(
    request: src_ui_crud_api_pb.ViewOverride,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: src_ui_crud_api_pb.ViewOverride) => void
  ): grpcWeb.ClientReadableStream<src_ui_crud_api_pb.ViewOverride>;
  ...
  getViewOverrides(
    request: src_ui_crud_api_pb.GetViewOverridesRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: src_ui_crud_api_pb.GetViewOverridesResponse) => void
  ): grpcWeb.ClientReadableStream<src_ui_crud_api_pb.GetViewOverridesResponse>;
...
export class CrudPromiseClient {
  ...
  getViewOverrides(
    request: src_ui_crud_api_pb.GetViewOverridesRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<src_ui_crud_api_pb.GetViewOverridesResponse>;
