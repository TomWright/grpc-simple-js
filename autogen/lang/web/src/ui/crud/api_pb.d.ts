...
export class DatasourceParamsGraphQL extends jspb.Message {
  ...
  setExclusionsList(value: Array<string>): DatasourceParamsGraphQL;
  clearExclusionsList(): DatasourceParamsGraphQL;
  addExclusions(value: string, index?: number): DatasourceParamsGraphQL;
...
export class ViewOverride extends jspb.Message {
  getUid(): string;
  setUid(value: string): ViewOverride;

  getUserid(): string;
  setUserid(value: string): ViewOverride;

  getDomainid(): string;
  setDomainid(value: string): ViewOverride;

  getTenantid(): string;
  setTenantid(value: string): ViewOverride;

  getViewid(): string;
  setViewid(value: string): ViewOverride;

  getData(): string;
  setData(value: string): ViewOverride;

  getName(): string;
  setName(value: string): ViewOverride;

  getCreatedat(): string;
  setCreatedat(value: string): ViewOverride;

  getCreatedby(): string;
  setCreatedby(value: string): ViewOverride;

  getUpdatedat(): string;
  setUpdatedat(value: string): ViewOverride;

  getUpdatedby(): string;
  setUpdatedby(value: string): ViewOverride;

  getDeletedat(): string;
  setDeletedat(value: string): ViewOverride;

  getDeletedby(): string;
  setDeletedby(value: string): ViewOverride;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ViewOverride.AsObject;
  static toObject(includeInstance: boolean, msg: ViewOverride): ViewOverride.AsObject;
  static serializeBinaryToWriter(message: ViewOverride, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ViewOverride;
  static deserializeBinaryFromReader(message: ViewOverride, reader: jspb.BinaryReader): ViewOverride;
}

export namespace ViewOverride {
  export type AsObject = {
    uid: string,
    userid: string,
    domainid: string,
...
export class Page extends jspb.Message {
  ...
  getViewidsList(): Array<string>;
  setViewidsList(value: Array<string>): Page;
  clearViewidsList(): Page;
  addViewids(value: string, index?: number): Page;
...
export class GetResourcesRequest extends jspb.Message {
  ...
  getDatasource(): Resource.Datasource;
  setDatasource(value: Resource.Datasource): GetResourcesRequest;

  getDatasourceparamscustom(): DatasourceParamsCustom | undefined;
  setDatasourceparamscustom(value?: DatasourceParamsCustom): GetResourcesRequest;
  hasDatasourceparamscustom(): boolean;
  clearDatasourceparamscustom(): GetResourcesRequest;

  getDatasourceparamselasticsearch(): DatasourceParamsElasticSearch | undefined;
  setDatasourceparamselasticsearch(value?: DatasourceParamsElasticSearch): GetResourcesRequest;
  hasDatasourceparamselasticsearch(): boolean;
  clearDatasourceparamselasticsearch(): GetResourcesRequest;

  getDatasourceparamsgraphql(): DatasourceParamsGraphQL | undefined;
  setDatasourceparamsgraphql(value?: DatasourceParamsGraphQL): GetResourcesRequest;
  hasDatasourceparamsgraphql(): boolean;
...
export class GetViewOverridesResponse extends jspb.Message {
  getViewoverridesList(): Array<ViewOverride>;
  setViewoverridesList(value: Array<ViewOverride>): GetViewOverridesResponse;
  clearViewoverridesList(): GetViewOverridesResponse;
  addViewoverrides(value?: ViewOverride, index?: number): ViewOverride;
...
export namespace GetViewOverridesResponse {
  export type AsObject = {
    viewoverridesList: Array<ViewOverride.AsObject>,
  }
}
